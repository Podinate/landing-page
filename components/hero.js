        ...
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            <h1 className="text-4xl font-bold leading-snug tracking-tight text-gray-800 lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight dark:text-white">
              We Love Containers, Cloud, and Code
            </h1>
            <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
              Podinate is an easy to use container platform built on top of Kubernetes.
              It creates a familiar environment for developers and makes it easy to deploy to production.
            </p>
            ...
            <div className="flex flex-col items-start space-x-3 space-y-3 sm:space-y-0 sm:items-center sm:flex-row">
              ...
              <a
                href="https://github.com/Podinate/podinate"
                target="_blank"
                rel="noopener"
